...
DIR_nfcore <- paste0(DIR_base, "nfcore/")
DIR_count <- paste0(DIR_nfcore, "results/cellranger/count/")
DIR_count_published <- "GPM_URL_2_Processed_data/cellranger/count/"
```
...
FASTQ files were generated using cellranger mkfastq (10x Genomics). The generated FASTQ files are analyzed by nfcore/scrnaseq pipeline (version 2.1.0) with cellranger aligner. This report was generated using custom scripts in R version 4.2.2. 
...
for (i in 1:length(samples)) {
  summaryFiles[[i]] <- paste0(DIR_count_published,samples[[i]],"/outs/web_summary.html")
}
```
