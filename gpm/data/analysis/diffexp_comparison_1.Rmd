...
deseq_output <- run_deseq_salmon(samples2, scaled_ct2)
```
...
* Download CSV file for the statistics of all valid genes in differential expression analysis: [`r paste0('Diff_Exp_genes_stats_',Tag_this_analysis,'.csv')`](`r paste0('Diff_Exp_genes_stats_',Tag_this_analysis,'.csv')`)
