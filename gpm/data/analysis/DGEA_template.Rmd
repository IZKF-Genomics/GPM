...
```{r, echo=FALSE, results="hide", warning=FALSE, message=FALSE}
# totalRNAseq, mRNAseq
# deseq_output <- run_deseq_salmon(samples2, spikein=spikein_ERCC,countsFromAbundance="lengthScaledTPM", lengthcorrection=TRUE)
# 3mRNAseq
# deseq_output <- run_deseq_salmon(samples2, spikein=spikein_ERCC, lengthcorrection=FALSE)
...
RNAseq_maplot_plotly_ERCC(deseq_output$lengthcorrection)
```
