...
d <- samples %>% separate(sample, c("group", "batch"))
samples$group <- d$group
samples$batch <- d$batch
...
filtered_samples <- samples[complete.cases(filtered_samples$group),]
