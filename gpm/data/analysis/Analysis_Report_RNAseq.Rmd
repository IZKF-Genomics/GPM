...
3. [Reports](GPM_URL_3_Reports):
    ...
    * Basic analysis of the Genomics Facility (This report)
    <!-- * [ERCC Spike-in Analysis](ERCC.html) -->
...
simple_PCA_ggplot2(salmon_count_table=paste0(DIR_salmon,"/salmon.merged.gene_counts_length_scaled.tsv"))
```

<!-- # Comparisons without duplicates

```{r, echo=FALSE, results="hide", warning=FALSE, message=FALSE}
group_base=""
group_comp=""
filetag <- paste0(group_comp, "_vs_",group_base)
description <- str_replace_all(filetag, "_", " ")
add_SimpleComparison(salmon_count_table=paste0(DIR_salmon,"/salmon.merged.gene_counts_length_scaled.tsv"), 
                     group_base=group_base, group_comp=group_comp)
rmarkdown::render(paste0('SimpleComparison_',filetag,'.Rmd'), output_format = 'html_document',
                  output_file = paste0('SimpleComparison_',filetag,'.html'))
```

### [`r description`](`r paste0('SimpleComparison_',filetag,'.html')`) -->
