...
Raw data was demultiplexed with cellranger mkfastq (10x Genomics v6.1.1) to generate fastq files for both GEX and VDJ libraries. The fastq files were then analyzed by the cellranger multi with default parameters. This report was generated using custom scripts in R version 4.2.2. 

# Reports of Cellranger multi for GEX and VDJ

### [Sample 1](GPM_URL_2_Processed_data/Sample_1/outs/per_sample_outs/Sample_1/web_summary.html)
### [Sample 2](GPM_URL_2_Processed_data/Sample_2/outs/per_sample_outs/Sample_2/web_summary.html)
