---
title: "220311 Brandt Berres MiedIII scCITEseq"
author:
...
4. [Compressed files for download](https://genomics.rwth-aachen.de/data/220311_Brandt_Berres_MiedIII_scCITEseq/compressed_tars):
...
```
wget -r --user USERNAME --password PASSWORD https://genomics.rwth-aachen.de/data/220311_Brandt_Berres_MiedIII_scCITEseq/compressed_tars/_1_Raw_data.tar.gz

wget -r --user USERNAME --password PASSWORD https://genomics.rwth-aachen.de/data/220311_Brandt_Berres_MiedIII_scCITEseq/compressed_tars/_2_Processed_data.tar.gz
```
